...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp0 yolov3/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='exp0 yolov3', help='save to project/name') #####################name
